<?php 
    ...
    {
	    $db = Database::connect();
	    $statement = $db->prepare('INSERT INTO whishlist (name, tome, serie, genre,  images, date_ajout) values ( ?, ?, ?, ?, ?, now())');
       ...
       <h1 class="text-logo"><span class="glyphicon glyphicon-book"></span> Bédé-Théque <span class="glyphicon glyphicon-book"></span></h1>
         <div class="container admin">
            <div class="row">
                ...
                <br>
                <form class="form" action="insert_whishlist.php" role="form" method="post" enctype="multipart/form-data">
