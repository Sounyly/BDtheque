...
$nomError = $tomeError = $serieError = $genreError = $typeError = $imageError = $nom = $tome = $serie = $genre = $type = $image = "";
    if(!empty($_POST)) // Si le mot de passe est bon
    {
        ...
        {
            $db = Database::connect();
            $statement = $db->prepare('INSERT INTO albums (name, tome, serie, genre, type, images, date_ajout) values ( ?, ?, ?, ?, ?, ?, now())');
            $statement->execute(array($nom, $tome, $serie, $genre, $type, $image));
            Database::disconnect();
        ...
        <div class="container m50">
            <div class="row">
                <div class=" col-md-12 col-lg-12 div-dessin-papillon">
                    ...
                    <h3 class="text-aside-circle">Ajouter une BD</h3>
                ...
                <div class="col-lg-offset-2 col-lg-8">
                    <div id="page-wrapper">
                     <div class="admin jumbotron">
                        <div class="row">
                            <form class="form" action="insert-bd.php" role="form" method="post" enctype="multipart/form-data">
                                <!-- formulaire titre -->
